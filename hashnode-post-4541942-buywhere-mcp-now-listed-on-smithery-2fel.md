---
title: "BuyWhere MCP now listed on Smithery"
slug: "buywhere-mcp-now-listed-on-smithery-2fel"
tags: "mcp, ai, opensource, webdev"
domain: "buywhere.hashnode.dev"
canonical: "https://dev.to/buywhere/buywhere-mcp-now-listed-on-smithery-2fel"
enableToc: true
subtitle: "BuyWhere MCP is now listed on Smithery — connect your shopping agent to a live cross-merchant product catalog."
seoTitle: "BuyWhere MCP now listed on Smithery"
seoDescription: "BuyWhere MCP is now listed on Smithery — connect your shopping agent to a live cross-merchant product catalog."
---
...
BuyWhere is now listed on [Smithery](https://smithery.ai/servers/buywhere) — alongside the other agentic commerce servers the MCP community is collecting.

Smithery makes it easy to connect an MCP server to your workflow in minutes. The listing page shows tool signatures, configuration snippets, and usage examples, so you can wire in BuyWhere without hunting through docs.
